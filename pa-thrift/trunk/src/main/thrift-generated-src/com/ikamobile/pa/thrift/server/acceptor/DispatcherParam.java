...
public class DispatcherParam implements org.apache.thrift.TBase<DispatcherParam, DispatcherParam._Fields>, java.io.Serializable, Cloneable, Comparable<DispatcherParam> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DispatcherParam");
  ...
  static {
    schemes.put(StandardScheme.class, new DispatcherParamStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DispatcherParamTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DispatcherParam.class, metaDataMap);
  }

  public DispatcherParam() {
  }
   ...
   */
  public DispatcherParam(DispatcherParam other) {
    if (other.isSetId()) {
      this.id = other.id;
    }
  ...
  public DispatcherParam deepCopy() {
    return new DispatcherParam(this);
  }
   ...
   * uuid id
   */
  public DispatcherParam setId(String id) {
    this.id = id;
    return this;
  }
   ...
   * 用户名
   */
  public DispatcherParam setLoginName(String loginName) {
    this.loginName = loginName;
    return this;
  }
   ...
   * 手机号
   */
  public DispatcherParam setPhoneNumber(String phoneNumber) {
    this.phoneNumber = phoneNumber;
    return this;
  }
   ...
   * 密码
   */
  public DispatcherParam setPassword(String password) {
    this.password = password;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DispatcherParam)
      return this.equals((DispatcherParam)that);
    return false;
  }

  public boolean equals(DispatcherParam that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DispatcherParam other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DispatcherParam(");
    boolean first = true;
  ...
  private static class DispatcherParamStandardSchemeFactory implements SchemeFactory {
    public DispatcherParamStandardScheme getScheme() {
      return new DispatcherParamStandardScheme();
    }
  }

  private static class DispatcherParamStandardScheme extends StandardScheme<DispatcherParam> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DispatcherParam struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DispatcherParam struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DispatcherParamTupleSchemeFactory implements SchemeFactory {
    public DispatcherParamTupleScheme getScheme() {
      return new DispatcherParamTupleScheme();
    }
  }

  private static class DispatcherParamTupleScheme extends TupleScheme<DispatcherParam> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DispatcherParam struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DispatcherParam struct) throws org.apache.thrift.TException {
